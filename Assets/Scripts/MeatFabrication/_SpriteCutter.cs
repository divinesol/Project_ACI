...
using GameObjectCreationMode = UnitySpriteCutter._SpriteCutterInput.GameObjectCreationMode;

namespace UnitySpriteCutter
{

    public class _SpriteCutterInput
    {
    ...
    public static class _SpriteCutter
    {

        struct SideCutData
        {
            public Mesh cuttedMesh;
            public List<_PolygonColliderParametersRepresentation> cuttedCollidersRepresentations;
        }

        /// <summary>
        /// Returns null, if cutting didn't took place.
        /// </summary>
        public static SpriteCutterOutput Cut(_SpriteCutterInput input)
        {
            ...
            _FlatConvexPolygonMeshCutter.CutResult meshCutResult =
            ...
            _FlatConvexCollidersCutter.CutResult collidersCutResults;
            if (input.dontCutColliders)
            {
                collidersCutResults = new _FlatConvexCollidersCutter.CutResult();
            }
            else
            {
                collidersCutResults =
            ...
            _SpriteCutterGameObject secondSideResult = null;
            switch (input.gameObjectCreationMode)
            {
                case GameObjectCreationMode.CUT_OFF_NEW:
                case GameObjectCreationMode.CUT_INTO_TWO:
                    secondSideResult = _SpriteCutterGameObject.CreateNew(input.gameObject, true);
                ...
                case GameObjectCreationMode.CUT_OFF_COPY:
                    secondSideResult = _SpriteCutterGameObject.CreateAsInstantiatedCopyOf(input.gameObject, true);
                    ...
                    if (copiedSpriteRenderer != null)
                    {
                        ...
                        _SafeSpriteRendererRemoverBehaviour.get.RemoveAndWaitOneFrame(copiedSpriteRenderer, onFinish: () => {
            ...
            _SpriteCutterGameObject firstSideResult = null;
            switch (input.gameObjectCreationMode)
            {
                case GameObjectCreationMode.CUT_OFF_NEW:
                case GameObjectCreationMode.CUT_OFF_COPY:
                    firstSideResult = _SpriteCutterGameObject.CreateAs(input.gameObject);
                    if (spriteRenderer != null)
                    {
                        _RendererParametersRepresentation tempParameters = new _RendererParametersRepresentation();
                        tempParameters.CopyFrom(spriteRenderer);
                        _SafeSpriteRendererRemoverBehaviour.get.RemoveAndWaitOneFrame(spriteRenderer, onFinish: () => {
                ...
                case GameObjectCreationMode.CUT_INTO_TWO:
                    firstSideResult = _SpriteCutterGameObject.CreateNew(input.gameObject, true);
                    PrepareResultGameObject(firstSideResult, spriteRenderer, meshRenderer, firstCutData);
                    break;
            }
        ...
        static _FlatConvexPolygonMeshCutter.CutResult CutSpriteOrMeshRenderer(Vector2 lineStart, Vector2 lineEnd, SpriteRenderer spriteRenderer, MeshRenderer meshRenderer)
        {
            Mesh originMesh = GetOriginMeshFrom(spriteRenderer, meshRenderer);
            return _FlatConvexPolygonMeshCutter.Cut(lineStart, lineEnd, originMesh);
        }
        ...
        static Mesh GetOriginMeshFrom(SpriteRenderer spriteRenderer, MeshRenderer meshRenderer)
        {
            if (spriteRenderer != null)
            {
                return _SpriteMeshConstructor.ConstructFromRendererBounds(spriteRenderer);
            }
            else
            {
        ...
        static _FlatConvexCollidersCutter.CutResult CutColliders(Vector2 lineStart, Vector2 lineEnd, Collider2D[] colliders)
        {
            return _FlatConvexCollidersCutter.Cut(lineStart, lineEnd, colliders);
        }

        static void PrepareResultGameObject(_SpriteCutterGameObject resultGameObject, SpriteRenderer spriteRenderer,
        ...
        static void PrepareResultGameObject(_SpriteCutterGameObject resultGameObject, _RendererParametersRepresentation tempParameters,
                                             SideCutData cutData)
        {
            resultGameObject.AssignMeshFilter(cutData.cuttedMesh);
