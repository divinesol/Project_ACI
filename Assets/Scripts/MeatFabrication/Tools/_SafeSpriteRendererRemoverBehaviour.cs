...
namespace UnitySpriteCutter.Tools
{
    ...
    /// </summary>
    public class _SafeSpriteRendererRemoverBehaviour : MonoBehaviour
    {

        static _SafeSpriteRendererRemoverBehaviour instance = null;

        public static _SafeSpriteRendererRemoverBehaviour get
        {
            get
            {
                if (instance == null)
                {
                    ...
                    instance = go.AddComponent<_SafeSpriteRendererRemoverBehaviour>();
                }
                return instance;
            }
        }
